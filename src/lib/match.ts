...
import { collection, query, where, getDocs, doc, setDoc, writeBatch, updateDoc, onSnapshot } from "firebase/firestore";
...
export const matchesStore = writable<{ [sessionId: string]: { loading: boolean, error: string | null, data: Match[] } }>({});
...
export async function getMatch(matchId: string): Promise<Match> {
  return await getItem(collection_name, matchId);
}
